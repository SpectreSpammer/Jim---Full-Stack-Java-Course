package com.onePieceOfJava.day6_arrays.answerForTheAssignment;
...
public class EmployeeManagementSystemsDay5 {
    ...
    public static void main(String[] args) {
        ...
        String dept2 = "HR";
        double annualGrossSalary2 = 2000000;
        boolean isReadyForRetire2 = true;

        String name3 = "Nami";
        int age3 = 30;
        long id3 = 456789012345L;
        String dept3 = "Finance";
        double annualGrossSalary3 = 2250000;
        boolean isReadyForRetire3 = false;
