package com.onePieceOfJava.day4_operators_in_java.answerForAssessment;
...
public class EmployeeManagementSystem {
    public static void main(String[] args) {
        ...
        boolean isReadyForRetire2 = false;
        ...
        boolean isReadyForRetire4 = true;
        ...
        */
         ...
         *
         * int x = 10
         * sout( x > 5 ? "Greater than 5" : "Less than 5")
         */
